    ...
    public void onLazyInitView(@Nullable Bundle savedInstanceState) {
        ...
        viewDelegate.viewHolder.swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ((OkexTrParentsFragment) getParentFragment()).tradeOnRefreshData(true);
            }
        });
        ...
        viewDelegate.viewHolder.tv_buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (viewDelegate.isLimit) {
                    binder.checkOrder(viewDelegate.tradeMode == 0 ? 1 : 4, OkexTrCloseFragment.this,viewDelegate.transactionBean.getAvailableflatSpace());
                } else {
        ...
        viewDelegate.viewHolder.tv_sell.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (viewDelegate.isLimit) {
                    binder.checkOrder(viewDelegate.tradeMode == 0 ? 2 : 3, OkexTrCloseFragment.this,viewDelegate.transactionBean.getAvailableflatMore());
                } else {
                        ...
                        if (getParentFragment().getParentFragment().getParentFragment() instanceof MainFragment) {
                            ((MainFragment) getParentFragment().getParentFragment().getParentFragment()).startBrotherFragment(
                                    CoinInfoFragment.newInstance(
                                            viewDelegate.tradeDetailBean.getKx(),
...
//                Log.i("wuli","data="+data);
                ...
                viewDelegate.transactionBean.setAlreadyOpenMore(
                        GsonUtil.getInstance().getValue(data, "alreadyOpenMore", String.class));
                viewDelegate.transactionBean.setAlreadyOpenSpace(
                        GsonUtil.getInstance().getValue(data, "alreadyOpenSpace", String.class));
